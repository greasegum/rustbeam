    ...
    <div className="app-pro">
      ...
      <button 
        ...
        onClick={() => {
          ...
          // Test updating bridge geometry
          const profile = state.bridgeGeometry.profile;
          if (profile) {
            console.log('🔄 Testing bridge geometry update...');
            state.setBeamLength(300); // Change length to 300 inches
